            ...
            return (
              ...
              >
                ...
                <div className={`flex flex-col gap-5 relative z-10 ${isReversed ? 'lg:order-last' : 'lg:order-first'}`}>
                  ...
                  {/* MAIN IMAGE: Blurred Background Technique */}
                  <div className="relative aspect-[16/10] md:aspect-[16/9] rounded-3xl overflow-hidden border border-white/20 shadow-[0_0_30px_rgba(0,0,0,0.5)]">
                    {/* Blurred Zoomed BG */}
                    <img 
                      src={item.mainImg} 
                  ...
                  {/* SMALL IMAGES: Blurred Background Technique */}
                  <div className="grid grid-cols-2 gap-5">
                    {[item.subImg1, item.subImg2].map((img, i) => (
