...
export default function Navbar() {
  ...
  return (
<div className="w-full fixed top-0 left-0 z-50 bg-white/10 backdrop-blur-md border-b border-white/20" >     
<div className="flex justify-between items-center px-4 md:px-10 md:pl-20 py-1 md:py-2 text-orange-400">
        ...
        <div className="hidden md:flex gap-8 font-semibold text-xl">
          ...
          <a href="/FacilityManagement" className="hover:text-orange-400 transition">
            Facility Management
          </a>

          <a href="/project" className="hover:text-orange-400 transition">
            Projects
          </a>
